...
namespace eduzora_lms.Controllers.Instructor
{
    ...
    public class InstructorController : Controller
    {
        ...
        public InstructorController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager,
        ...
        public IActionResult Registration()
        {
            ...
            return View("~/Views/Instructor/Registration.cshtml");
        }

        // Registration Form Page
        [HttpPost("registration")]
        public async Task<IActionResult> Registration(InstructorRegistrationViewModel model)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return View("~/Views/Instructor/Registration.cshtml", model);
            }
            ...
            if (result.Succeeded)
            {
                ...
                if (roleAssignResult.Succeeded)
                {
                    ...
                    string emailBody = $@"
                        <p>Dear {user.Email}, Instructor</p>
                        ...
                        <p><a href='http://localhost:5271
                    {HtmlEncoder.Default.Encode(callConfirmEmail!)}'</a></p>
                        <p>Thanks,<br>The EduzoraLMS Team</p>";

                    // Sent Email Implementation Method.
                    await emailSender.sendEmailAsync("Harsh_P_@AspDotNetCore.Com", user.Email!, "Confirm Your Email-Address for Instructor EduzoraLMS", emailBody, true);
                    ...
                    return View("~/Views/Instructor/Registration.cshtml", new InstructorRegistrationViewModel());
