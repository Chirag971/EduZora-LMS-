...
namespace eduzora_lms.Controllers.Student
{
    ...
    public class StudentDashboardController : Controller
    {
        ...
        public StudentDashboardController(SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.CurrentPage = "student-dashboard";

            return View("~/Views/StudentDashboard/Index.cshtml");
        }


        // Student Edit Profile Page Ui
        ...
        public async Task<IActionResult> EditProfile()
        {
            ...
            var model = new StudentEditProfileViewModel
            {
            ...
            return View("~/Views/StudentDashboard/EditProfile.cshtml", model);
        }

        // Student Edit-Profile Page Form Submit
        ...
        public async Task<IActionResult> EditProfile(StudentEditProfileViewModel model)
        {
            ...
            return RedirectToAction("EditProfile","StudentDashboard");
        }
